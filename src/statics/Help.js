  ...
  (<div className="main-panel help-section">
    <div className="container text-center my-5">
      ...
      >
        ...
        {' '}
        or <a target="_blank" rel="noopener noreferrer" href="https://signup.steemit.com">Sign up with Steemit</a>
      </div>
      }
      ...
      <p>
        Utopian rewards Open Source contributors by allowing them to create <b>Contributor Reports</b>. The Contributor
        Reports are voted by the Utopian community members. The contributor receives <a href="https://steem.io" target="_blank"> Steem </a>
        cryptocurrency as a reward based on the amount of votes received and the impact of each single vote (rank of the
        voting user in the platform). Utopian uses the <a href="https://steem.io" target="_blank">Steem</a> blockchain
      ...
      <p>Utopian is based on <a href="https://steem.io" target="_blank">Steem</a>. Utopian does not have a separate
        ...
        contributors when their Contribution Reports are upvoted by the Utopian community. <em>The registration verification
